...
public class Main {
    ...
    //AnimalData의 필드가 Animal 클래스의 서브 클래스에 해당하는지 확인하는 메서드
...
//        //현재 AnimalData에 Car 객체가 들어가 있지만 오류가 발생하지 않습니다.
...
//        AnimalData<? extends Animal> animalData6 = main.getAnimal(3);
        ...
        // 이상의 코드의 결과 animlaData4,5,6에는 뭔지 모를 클래스의 객체기 필드로 들어가 있습니다.
