...
/*
    packge명은 소문자로 작성
    class명은 대문자로 시작하고 복수의 단어인 경우에는 다음과 같이 작성함
        ex) 한단어 : Example01
            복수단어 : MyExample01
    이상에서 확인할 수있는것은 클래스 작성법이 변수 작성명과 유사하기는 하지만,
...
//        System.out.println(i);
        ...
        //대입 연산자 : '='      = 오른쪽에 있는 데이터를 = 왼쪽에 있는 변수에 대입한다는 의미로 변수와 데이터가 동일하다는 것은 아니다.

        //a와 b가 같은 값을 지니고 있다는 의미로 표시를 할때에는
        //a == b
...
//        System.out.println(j);              //윗줄의 결과 11이 출력
...
//        System.out.println("10 / 4 의 나머지 : " + (10%4));
//
